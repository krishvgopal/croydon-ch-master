<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MainNavigation.ascx.cs" Inherits="Common_MainNavigation" %>
 ...
 <ul class="nav" id="side-menu">
    ...
    <li><a title="Search"               name="menuList" href="Search.aspx"              thisLabel="&nbsp;Name & Address"    thisFA="fa-search">     <i class="fa fa-search fa-fw"></i>      </a></li>
    <li><a title="Debt Search"          name="menuList" href="DebtSearch.aspx"          thisLabel="&nbsp;Debt"              thisFA="fa-search">     <i class="fa fa-search fa-fw"></i>      </a></li>
